...
/*        String filePath = "image"; // 문자열을 인식할 이미지 파일 경로
        ...
        pDTO.setUserId("2320110212");
        pDTO.setUserName("JeongukChoi");
        pDTO.setEmail("onsucjuk@naver.com");
        pDTO.setAddr("Seoul");

        pList.add(pDTO);

        StudentDTO pDTO1;
        pDTO1 = new StudentDTO();
        pDTO1.setUserId("2320110213");
        pDTO1.setUserName("MinsuKim");
        pDTO1.setEmail("inchongu@naver.com");
        pDTO1.setAddr("Gyeongki");
